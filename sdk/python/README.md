...
1. A `provider/` folder containing the building and implementation logic
   1. `cmd/`
      1. `pulumi-gen-konnect/` - generates language SDKs from the schema
      2. `pulumi-resource-konnect/` - holds the package schema, injects the package version, and starts the gRPC server
   2. `pkg`
...
The [JSON schema file](https://www.pulumi.com/docs/guides/pulumi-packages/schema) is used by `pulumi-gen-konnect` to create language-specific SDKs. 
...
This repository provides the [konnect example schema](./provider/cmd/pulumi-resource-konnect/schema.json) to get you started.  
