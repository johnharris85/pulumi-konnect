...
import (
	...
	pbempty "google.golang.org/protobuf/ptypes/empty"
	"io/ioutil"
	"net/http"
)
...
func (p *konnectProvider) CheckConfig(_ context.Context, req *rpc.CheckRequest) (*rpc.CheckResponse, error) {
	return &rpc.CheckResponse{Inputs: req.GetNews()}, nil
}

// DiffConfig diffs the configuration for this provider.
func (p *konnectProvider) DiffConfig(_ context.Context, _ *rpc.DiffRequest) (*rpc.DiffResponse, error) {
	return &rpc.DiffResponse{}, nil
}

// Configure configures the resource provider with "globals" that control its behavior.
func (p *konnectProvider) Configure(_ context.Context, _ *rpc.ConfigureRequest) (*rpc.ConfigureResponse, error) {
	return &rpc.ConfigureResponse{}, nil
}

// Invoke dynamically executes a built-in function in the provider.
func (p *konnectProvider) Invoke(_ context.Context, _ *rpc.InvokeRequest) (*rpc.InvokeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "StreamInvoke is not yet implemented")
}

// StreamInvoke dynamically executes a built-in function in the provider. The result is streamed
// back as a series of messages.
func (p *konnectProvider) StreamInvoke(_ *rpc.InvokeRequest, _ rpc.ResourceProvider_StreamInvokeServer) error {
...
func (p *konnectProvider) Check(_ context.Context, req *rpc.CheckRequest) (*rpc.CheckResponse, error) {
...
func (p *konnectProvider) Diff(_ context.Context, _ *rpc.DiffRequest) (*rpc.DiffResponse, error) {
	return &rpc.DiffResponse{}, nil
}

// Create allocates a new instance of the provided resource and returns its unique ID afterwards.
func (p *konnectProvider) Create(_ context.Context, req *rpc.CreateRequest) (*rpc.CreateResponse, error) {
...
func (p *konnectProvider) Read(_ context.Context, req *rpc.ReadRequest) (*rpc.ReadResponse, error) {
	id := req.GetId()
...
func (p *konnectProvider) Update(_ context.Context, req *rpc.UpdateRequest) (*rpc.UpdateResponse, error) {
...
// to still exist.
func (p *konnectProvider) Delete(_ context.Context, req *rpc.DeleteRequest) (*pbempty.Empty, error) {
	url := fmt.Sprintf("%s%s", p.metadata.BaseUrl, req.GetId())
...
func (p *konnectProvider) Construct(_ context.Context, _ *rpc.ConstructRequest) (*rpc.ConstructResponse, error) {
	return nil, status.Error(codes.Unimplemented, "Construct is not yet implemented")
}

// GetPluginInfo returns generic information about this plugin, like its version.
func (p *konnectProvider) GetPluginInfo(context.Context, *pbempty.Empty) (*rpc.PluginInfo, error) {
...
func (p *konnectProvider) GetSchema(_ context.Context, _ *rpc.GetSchemaRequest) (*rpc.GetSchemaResponse, error) {
...
func (p *konnectProvider) Cancel(context.Context, *pbempty.Empty) (*pbempty.Empty, error) {
	return &pbempty.Empty{}, nil
}
