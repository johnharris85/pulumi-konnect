...
import (
	...
	"github.com/johnharris85/pulumi-konnect/provider/pkg/version"
...
const (
	...
	mainPkg = "konnect" // the konnect module
)
...
func makeResource(mod string, res string) tokens.Type {
	return tfbridge.MakeResource("konnect", mod, convertName(res))
}
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			// 		"tags": {Type: tfbridge.MakeType("konnect", "Tags")},
			// 	},
			// },
			...
			"konnect_runtime_group":           {Tok: tfbridge.MakeResource(mainPkg, mainMod, "RuntimeGroup")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"konnect_runtime_group": {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getRuntimeGroup")},
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/johnharris85/pulumi-%[1]s/sdk/", "konnect"),
